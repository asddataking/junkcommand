...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${SITE_URL}/work-with-junk-command`, lastModified: now, changeFrequency: "monthly", priority: 0.6 },
    ...
    { url: `${SITE_URL}/what-we-dont-take`, lastModified: now, changeFrequency: "yearly", priority: 0.6 },
    ...
    {
      url: `${SITE_URL}/what-we-take`,
      lastModified: now,
      changeFrequency: "monthly",
      priority: 0.8,
    },
    {
      url: `${SITE_URL}/commercial-junk-removal`,
      lastModified: now,
      changeFrequency: "monthly",
      priority: 0.8,
    },
    {
      url: `${SITE_URL}/responsible-disposal`,
      lastModified: now,
      changeFrequency: "monthly",
      priority: 0.7,
    },
